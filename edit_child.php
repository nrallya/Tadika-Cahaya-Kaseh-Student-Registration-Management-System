...
$childID = isset($_GET['childID']) ? $_GET['childID'] : 0;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_query($conn, $updateSql)) {
        echo "<script>alert('Student updated successfully'); window.location.href = 'studentmanagement.php';</script>";
    } else {
...
<body>
    ...
    <div class="container">
        ...
        <a href="studentmanagement.php" class="back-btn">Back</a>
    </div>
</body>
</html>
