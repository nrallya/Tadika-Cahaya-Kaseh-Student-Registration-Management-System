...
<body>
    <div class="container">
        <h1>Activities for K1</h1>
        
        <?php
        include "connection.php"; // Make sure this file contains your database connection details

        // Query to fetch content items for K1 (class_id = 2)
        $sql_content = "SELECT category, content FROM content_items WHERE class_id = 2";
        ...
        // Query to fetch fees for K1 (class_id = 2)
        $sql_fees = "SELECT fee_type, amount FROM fees WHERE class_id = 2";
